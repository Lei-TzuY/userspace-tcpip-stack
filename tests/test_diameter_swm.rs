...
fn test_diameter_swm_eap_aka_prime_handshake() {
    ...
    let eap_resp = vec![0x02, 0x01, 0x00, 0x10, 0x32, 0x00, 0x00, 0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00, 0x01];
...
fn test_diameter_swm_eap_rejection() {
    ...
    let der = SwmMessage::new_der("swm-sess-46002", "460010000000002", "WLAN", vec![0x04, 0x01, 0x00, 0x04]);
    let dea = aaa.handle_der(&der);
