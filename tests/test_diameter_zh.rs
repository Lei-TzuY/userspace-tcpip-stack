use toy_tcpip::diameter_zh::{
    BsfZhEngine, GbaAuthVector, GbaType, ZhAvp, ZhMessage, DIAMETER_APPLICATION_ZH,
    DIAMETER_CMD_MULTIMEDIA_AUTH,
};
...
fn test_diameter_zh_bootstrapping_and_naf_key_derivation() {
    ...
    bsf.register_subscriber("460019998887771", "<guss-profile>active</guss-profile>", vec);
    ...
    let ks_naf = bsf.derive_ks_naf("460019998887771", "secure.banking.naf").unwrap();
